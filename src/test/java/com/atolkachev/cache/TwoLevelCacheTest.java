package com.atolkachev.cache;

import com.atolkachev.cache.policies.PolicyType;
...
public class TwoLevelCacheTest {
  ...
  @Test
  public void testUseMostRecentlyUsedCachePolicy() {
    twoLevelCache = new TwoLevelCache<>(1, 1, PolicyType.MOST_RECENTLY_USED);
