...
public class LeastRecentlyUsedCacheTest {
  ...
  public void setTwoLevelCache() {
    twoLevelCache = new TwoLevelCache<>(2, 2, PolicyType.LEAST_RECENTLY_USED);
  }
  ...
  public void testReplaceObjectFromCache() {
    ...
    assertFalse(twoLevelCache.isObjectContained(KEY0)); // Replaced from 1st level cache as least recently used
  }
}
